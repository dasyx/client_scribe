import { c as create_ssr_component, b as compute_rest_props, a as setContext, d as spread, e as escape_object, f as escape_attribute_value, g as add_attribute, i as is_void, n as noop, h as getContext, j as escape, k as get_current_component, v as validate_component, l as add_styles, o as globals, p as compute_slots, m as missing_component } from "../../chunks/index.js";
...
const IoMdHome = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({}, { viewBox: "0 0 512 512" }, $$props), {}, {
    default: () => {
      return `<path d="M208 448V320h96v128h97.6V256H464L256 64 48 256h62.4v192z"></path>`;
    }
  })}`;
});
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<div${add_styles({ "width": `30px` })}>${validate_component(IoMdHome, "IoMdHome").$$render($$result, {}, {}, {})}</div>
	...
	${validate_component(NavUl, "NavUl").$$render($$result, { hidden }, {}, {
        default: () => {
          return `
		${validate_component(NavLi, "NavLi").$$render($$result, { id: "nav-menu1", class: "cursor-pointer" }, {}, {
            default: () => {
...
const css = {
  code: ".test.svelte-yrs0ph{color:blue}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<footer><p class="test svelte-yrs0ph">Un texte pour test</p>
</footer>`;
});
const styles = "";
